...
loss_function = utils.DiceBCELoss() #import loss function from utils module 
unet_model = u_net.UNet()  # import UNet implementation from u_net module
...
for epoch in range(N_EPOCHS):
    ...
    for batch in dataloader:
        ...
        outputs = unet_model(inputs)  # forward pass of model
        loss = loss_function(outputs, targets)  # computing loss
        loss.backward()  # backpropagating
        optimizer.step()  # stepping the optimiser
