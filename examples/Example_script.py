...
OUTPUT_DIR = r'D:\capita_selecta\results'

# Make a results directory if non exists
if os.path.exists(OUTPUT_DIR) is False:
    os.mkdir(OUTPUT_DIR)

DATA_PATH = r'D:\capita_selecta\ImagesforPractical\MR'

# Define the paths to the two images you want to register
fixed_image_path = os.path.join(DATA_PATH, 'patient1.jpg')
moving_image_path = os.path.join(DATA_PATH, 'patient2.jpg')
...
el.register(
    ...
    parameters=[os.path.join(DATA_PATH, 'parameters_bspline_multires_MR.txt')],
